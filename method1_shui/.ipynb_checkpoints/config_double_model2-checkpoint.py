...
def parse_args():
    ...
    parser.add_argument('--dropout', type=float, default=0.2, help='dropout ratio')#改动 0.3-->0.2
    parser.add_argument('--num_folds', type=int, default=5, help='K fold')
    ...
    parser.add_argument('--test_output_csv', type=str, default='saves/double_model2/result.csv')
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='saves/double_model2/')
    ...
    parser.add_argument('--bert_warmup_steps', type=int, default=3000) # 默认5000-->3000
    ...
    parser.add_argument('--vlad_cluster_size', type=int, default=128)#改动64-->128
    ...
    # ========================== Fusion Layer =============================
    parser.add_argument('--fc_size', type=int, default=1024, help="linear size before final linear") #改动512-->1024
    
    # ========================== debuge =============================
    parser.add_argument('--debuge', type=bool, default=True, help="debuge")
    
    parser.add_argument('--version', type=str, default='_double_model1', help="version")
    
    # ========================== fintinue =============================
    parser.add_argument('--pretrain_bert_path', type=str, default='pretrain-model/roberta-wwm-base', help="pretrain_bert_path")
    parser.add_argument('--pretrain_path', type=str, default='pretrain-model/bert_pretrain_1.pth', help="pretrain_path")
    
    # ========================== pretrain =============================
    parser.add_argument('--pretrain_bert_output_path', type=str, default='./pretrain-model/bert_pretrain_1.pth', help="pretrain_bert_output_path")
