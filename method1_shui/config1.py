...
def parse_args():
    ...
    parser.add_argument('--version', type=str, default='single15_ub3_fintune', help="version")
    ...
    # ========================== pretrain =============================
    parser.add_argument('--ispretrain', type=int, default=1, help="whether pretrain")
    ...
    parser.add_argument('--prefetch', default=30, type=int, help="use for training duration per worker")
    parser.add_argument('--num_workers', default=4, type=int, help="num_workers for dataloaders")

    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='save/single15_ub3_fintune')
